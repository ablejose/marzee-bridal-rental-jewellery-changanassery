...
export const BRAND: BrandConfig = {
  businessName: "Marzee bridal rental jewellery",
  tagline: "Your Trusted Jewellery Store in Changanassery",
  description:
    "Marzee bridal rental jewellery is Changanassery's trusted destination for gold, diamond and silver jewellery. Serving Changanassery and surrounding areas with timeless craftsmanship for every celebration — from weddings and festivals to everyday elegance.",
  ...
  address: "opposite S B College, near Municipal Park, Changanassery, Kerala 686101",
  city: "Changanassery",
  state: "Kerala",
  pincode: "686101",

  phone: "+917736546474",
  whatsapp: "917736546474",
  email: "",

  mapsLink:
    "https://share.google/ZnnTeo3cmXdTL9tOZ",

  openingHours: "Mon–Sat: 9:30 AM – 8:00 PM · Sunday: 10:00 AM – 7:00 PM",

  instagram: "https://www.instagram.com/marzee_rental_jewellery",
  facebook: "",

  seo: {
    title: "Marzee bridal rental jewellery | Gold & Diamond Jewellery in Changanassery",
    description:
      "Marzee bridal rental jewellery — Changanassery's premier jewellery store. Exquisite gold, diamond and silver collections for every occasion. Visit us in Changanassery, Kerala.",
    keywords: [
      "Marzee bridal rental jewellery",
    ...
    canonical: "https://marzee-bridal-rental-jewellery-changanassery.vercel.app",
  ...
  whatsappMessage:
    "Hello Marzee bridal rental jewellery, I'd like to know more about your jewellery collections.",
};
